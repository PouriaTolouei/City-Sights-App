...
struct BusinessMap: UIViewRepresentable {
    ...
    class Coordinator: NSObject, MKMapViewDelegate {
        ...
        // Give us access to the read the model and set the selectedBusiness
        init(map: BusinessMap) {
            self.map = map
        }
        
        // Provide annotation view for each annotation
        func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
            ...
            if annotationView == nil {
                ...
                // Create a new one if there's no reusable one
        ...
        // Tell the delegate that the user tapped one of the annotation view's accessory buttons
